 ...
 *
 * @author Josh Bloch
 * @author Neal Gafter // * @see Collection // * @see Set // * @see ArrayList //
 *         * @see LinkedList // * @see Vector // * @see Arrays#asList(Object[])
 *         // * @see Collections#nCopies(int, Object) // * @see
 *         Collections#EMPTY_LIST // * @see AbstractList // * @see
...
public interface SortedList<E extends Comparable<E>> {
	 ...
	 *                                   than 0 or index greater than or equal to
	 *                                   size)
	 */
	E get(int index);
